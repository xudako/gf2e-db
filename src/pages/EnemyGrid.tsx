...
const EnemyGrid: React.FC = () => {
  return <div className="bg-background-paper shadow-md p-6 mb-8">
    <span className="text-lg font-bold">Nemertea</span>
      {skills.map((skillId) => (
        <div className="grid grid-cols-12 mb-4 p-4 border border-slate-700">
          ...
          <div className="col-span-2"><RichText content={Tables.BattleSkillDisplayData[skillId].name} /></div>
          <div className="col-span-8"><RichText content={Tables.BattleSkillDisplayData[skillId].description} descriptionTips={Tables.BattleSkillDisplayData[skillId].descriptionTips} /></  div>
        </div>
      ))}
